          ...
          <div className="grid grid-cols-5 gap-4 items-center">
            <div className="flex flex-col items-center">
              ...
              <div className="text-center">
                <img src="./src/assets/Bookingid.png" className="rounded-full w-16 h-16" />
            ...
            <div className="flex flex-col items-center">
            <img src="./src/assets/category.png" className="rounded-full w-16 h-16" />
            ...
            <img src="./src/assets/20.png" className="rounded-full w-16 h-16" />
              <div className="text-center">
            ...
            <div className="flex flex-col items-center">
            <img src="./src/assets/17.png" className="rounded-full w-16 h-16" />
              <div className="text-center">
