          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 items-center">
            <div className="flex flex-col items-center">
              <div className="text-center">
                <img src="/assets/Bookingid.png" className="rounded-full w-16 h-16" alt="Booking ID" />
            ...
            <div className="flex flex-col items-center">
              <img src="/assets/category.png" className="rounded-full w-16 h-16" alt="Category" />
              <div className="text-center">
            ...
            <div className="flex flex-col items-center mt-6 md:mt-0">
              <img src="/assets/20.png" className="rounded-full w-16 h-16" alt="Session Time & Date" />
              <div className="text-center">
            ...
            <div className="flex flex-col items-center">
              <img src="/assets/17.png" className="rounded-full w-16 h-16" alt="Booking Status" />
              <div className="text-center">
            ...
            <div className="flex flex-col items-center">
              <button className="px-6 py-2 bg-red-500 text-white rounded-full">
                <a href="https://www.google.com" target="_blank" rel="noopener noreferrer">Join Session</a>
              </button>
            </div>
          </div>
        </div>
